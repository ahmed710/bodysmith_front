...
export const defaultNavigation: FuseNavigationItem[] = [
    {
        ...
        children: [
            ...
            {
                id: 'dashboards.list-product',
                title: 'Manage Products',
                type: 'basic',
                icon: 'heroicons_outline:duplicate',
                link: '/dashboards/list-product',
            },
            {
            ...
            {
                id: 'dashboards.zouhour-coaches',
                title: 'zouhour Coaches',
                type: 'basic',
                icon: 'heroicons_outline:duplicate',
                link: '/dashboards/zouhour-coaches',
            },
            {
            ...
            },
            {
                ...
                type: 'basic',
                icon: 'heroicons_outline:duplicate',
                link: '/dashboards/sessions',
            },
            {
                id: 'dashboards.reservation',
                title: 'reservation',
                type: 'basic',
                icon: 'heroicons_outline:duplicate',
                link: '/dashboards/reservation',
            },
            {
                id: 'dashboards.reserver',
                title: 'Reserver',
                type: 'basic',
                icon: 'heroicons_outline:duplicate',
                link: '/dashboards/reservation/reserver',
            },
        ],
    },
    {
